...
For more information about Maven flags, see
[--maven-artifact](../reference/workload-create-apply.hbs.md#maven-artifact) in the command reference.
...
For information about how to configure the credentials that the Maven artifact needs for authentication,
